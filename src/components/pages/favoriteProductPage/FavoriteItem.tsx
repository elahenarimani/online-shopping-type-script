            ...
            {favoriteProductsDetails?.map((item) => {
              return (
                <div key={item?.id} className="">
                  <div className="w-[180px] h-full border-solid border-[#E6E6E6] border-[2px] rounded-[5px] flex flex-col justify-start gap-[8px] pt-0 mt-0 ">
                    ...
                    <Link to={`/checkout/cart/`}>
                      <Button
                        className="w-full h-[32px]  bg-[#A72F3B] text-white flex justify-center items-center "
                        onClickHandler={() =>
